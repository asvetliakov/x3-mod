...
// sun-shadow lane's A32B32G32R32F RT2 keeps .b as the apply quad's receiver
// depth (docs/architecture/shadow-receiver-depth.md); the lane-off R32F RT2
// drops those lanes at the format, so one fragment serves both modes and .r
// is produced by the same two instructions in each. No
