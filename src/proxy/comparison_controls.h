...
// Ctrl+Alt+F11 (Shift up, its own raw latch) is the fog dust motes' on/off.
struct ComparisonKeys {
    ...
    bool fog_dust_motes = false; // F11 raw (with --fog-dust-motes): fires on Ctrl+Alt with Shift up
