...
constexpr unsigned char sat_pre_window[sat_pre_length] = {
    0xd9,0xc9, 0x83,0xc0,0x30, 0xd9,0x5c,0x24,0x20, 0x50, 0xd9,0x45,0x34, 0x53, 0xd8,0xc9, 0x8d,0x7c,0x24,0x28,
    0xd9,0x5c,0x24,0x2c, 0xd8,0x4d,0x38, 0xd9,0x5c,0x24,0x30};
...
inline double through_float(double v) { return static_cast<double>(abs_f(static_cast<float>(v))); }
inline double bf(float r) { return static_cast<double>(static_cast<float>(static_cast<double>(abs_f(r)) + static_cast<double>(reps))); }
