...
void camera_context(std::uintptr_t cockpit, std::uintptr_t ship,
                    std::uintptr_t camera, std::uint32_t mode,
                    std::uint32_t connect, std::uint32_t flags_1a0,
                    bool applied, std::uint64_t stamp);
