...
bool initialize() {
    ...
    initialized=true;
    const bool wanted=log_tier::draw_trace_flag(L"X3M_PASS_PHASES"); // X3M_PASS_PHASES=1 or X3M_DRAW_TRACE=1 (log_tiers.h)
...
detail::Accumulator* shared_accumulator() noexcept {return &accumulator;}
namespace detail {
