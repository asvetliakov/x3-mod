...
inline bool same(const Identity& a, const Identity& b) {
    return a.generation && a.serial && a.generation == b.generation && a.serial == b.serial && a.thread == b.thread &&
           a.cockpit == b.cockpit && a.ship == b.ship && a.ship_id == b.ship_id && a.target == b.target &&
           a.target_id == b.target_id && a.camera == b.camera && a.scene == b.scene && a.sector == b.sector &&
           a.overlay == b.overlay && a.marker == b.marker;
}
struct Projection {
