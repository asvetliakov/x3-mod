...
// and, one word further, the caller's saved EDI, which 0x004e29f0 reads as its tenth argument: the running-minimum
// pointer it stores in [0x00608540] (0 at 0x0048a9a5, a local float at 0x0048a69e). Everything the query reads is in
...
struct Counters { std::uint32_t hits, misses, stored, contacts, ineligible, evictions, skipped_visits, skipped_triangles, verified, verify_mismatches; };
