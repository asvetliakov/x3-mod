...
enum class Status : std::uint32_t {
    ...
    launch_failed,scheduled,preparing,prepared,ready,callback_failed
};
struct Snapshot {
...
public:
    ...
    bool configure(Bootstrap,void* context) noexcept;
...
private:
    ...
    Bootstrap callback_=nullptr;void* context_=nullptr;
