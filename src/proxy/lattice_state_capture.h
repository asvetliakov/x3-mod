...
class Capture {
public:
    void arm(std::uint64_t device,std::uint64_t frame,std::uint64_t generation,bool scope_active) noexcept;
    void invalidate() noexcept {policy_.refuse(Status::Reset);}
