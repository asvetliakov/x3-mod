...
void initialize_log(HMODULE module) {
    ...
    collide_descent_sse2::initialize(); // X3M_COLLIDE_DESCENT_SSE2=1 only; the sole external call of the OBB-tree descent 0x004e2530 (at 0x004e2956) redirected to an SSE2 reimplementation, same window, after the census and the SAT so their bytes are already settled
