...
State global;
constexpr const char* names[]={"lock_wait","create_device","present_normal","present_capture","frame_normal","frame_capture","draw_backend","capture_cpu","snapshot","shader_vs_backend","shader_ps_backend","shader_inspect","shader_getfunction","shader_hash","shader_dump","texture","cube_texture","volume_texture","render_target","depth_stencil","vertex_buffer","index_buffer","reset","log_flush","cursor_properties","cursor_position","cursor_show","stretch_backend","route_gate","route_draw","route_set_rt","route_jitter","route_fill","route_lazy_flush","route_readback","taa_run","taa_state_capture","taa_copy_color","taa_copy_depth","taa_resolve_draw","taa_state_apply","taa_copy_back"};
