...
public:
    ...
    MotionCaptureDiagnostics before_clear(IDirect3DDevice9* application, const renderer::Selection&,
                                          DiagnosticConsumer consumer = nullptr, void* context = nullptr) noexcept;
