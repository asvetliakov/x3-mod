...
using CloneTarget = HRESULT(STDMETHODCALLTYPE*)(ID3DXMesh*, DWORD, const D3DVERTEXELEMENT9*, IDirect3DDevice9*,
                                                ID3DXMesh**);
}
...
HRESULT clone_mesh_upload_target(clone_upload_abi::CloneTarget, ID3DXMesh*, DWORD, const D3DVERTEXELEMENT9*,
