#!/usr/bin/env python3
"""The temporal pass and its lattice mode against the committed summary (the option never reaches TemporalPass here:
FrameInputs::thin_vote stays false and configure_thin_vote is not called): pass flags, check counts and the two report
hashes, plus the budget rows of the embedded programs. Prints one line per field and a verdict.
