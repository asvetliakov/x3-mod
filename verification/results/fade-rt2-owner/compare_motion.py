#!/usr/bin/env python3
"""(Copied from verification/results/thin-vote.) The X3M_FADE_RT2_OWNER option-off path against the committed
motion-output summary (4de081ae): every case of the committed summary is still
