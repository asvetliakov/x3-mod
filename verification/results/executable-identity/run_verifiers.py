...
game) and, for two verifiers, site_corrupt (one site byte flipped).
...
# One byte per corrupt case: the chase camera's jz displacement and the LOD-scale fmul operand.
SITE_CORRUPT = {'verify_chase_camera_site': 0x00420e0f, 'verify_lod_scale_site': 0x0047d44d}
