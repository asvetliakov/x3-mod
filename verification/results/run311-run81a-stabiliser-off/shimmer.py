...
run=sys.argv[1]; X0,Y0,X1,Y1,F0,N=map(int,sys.argv[2:8]); S=int(os.environ.get('S',16))
WMIN=float(os.environ.get('WMIN',20000)); REL=float(os.environ.get('REL',0.10)); DIL=int(os.environ.get('DIL',6)); M=64
