...
def main():
    ...
    files = ('verification/probe/scene_capture_fixture.cpp',
             ...
             'src/ownership/d3d9_ownership.cpp', 'src/ownership/finite_buffer_evidence.cpp', 'src/ownership/finite_buffer_evidence.h', 'src/ownership/managed_upload_contract.cpp', 'src/ownership/managed_upload_contract.h', 'src/ownership/d3d9_ownership.h',
