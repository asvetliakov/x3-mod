...
// src/proxy/terran_station_lod.cpp by build_terran_lod_patch.py, with
// -DX3M_TERRAN_LOD_SHIM, and nowhere else. It routes the four calls the
...
// wrappers defined in terran_lod_patch_fixture.cpp, which call the real
...
#ifdef X3M_TERRAN_LOD_SHIM
#define VirtualProtect x3m::terran_lod_fixture::virtual_protect
#define FlushInstructionCache x3m::terran_lod_fixture::flush_instruction_cache
