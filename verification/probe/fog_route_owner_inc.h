...
// The dust motes' A/B witness reads back the last frame row and toggle row the production fragment logged.
inline char last_frame_row[2048]{},last_motes_row[512]{};inline unsigned frame_rows=0,motes_rows=0;
