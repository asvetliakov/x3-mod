...
from verify_ownership_integration import verify_geometry
...
env=dict(os.environ,X3M_OWNERSHIP='1',X3M_DEPTH_COPY='0',X3M_SCENE_DEPTH_CAPTURE='0',X3M_OBJECT_TRACE='0',X3M_OBJECT_LIFETIME='0',X3M_MESH_CACHE='0',X3M_FINITE_POSITIONS='1',X3M_TELEMETRY='1',X3M_CAPTURE_START='1',X3M_CAPTURE_FRAMES='1')
