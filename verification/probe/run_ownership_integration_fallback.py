...
object_hashes={str(p.relative_to(root)):sha(p) for p in (root/'build-ownership/CMakeFiles/d3d9.dir/src/proxy').glob('*.obj')}
...
env=dict(os.environ,X3M_OWNERSHIP='1',X3M_DEPTH_COPY='0',X3M_TELEMETRY='1',X3M_CAPTURE_START='1',X3M_CAPTURE_FRAMES='1')
