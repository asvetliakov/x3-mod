...
try:
    ...
    assert 'FAR_BASE numerical=357 state_restorations=17' in lattice_text and len(report['thin_region']['cases'])==15 and all(c['square_differs']=='0' for c in report['thin_region']['cases']),report['thin_region']
