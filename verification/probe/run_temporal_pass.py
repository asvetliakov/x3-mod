...
try:
    ...
    report['thin_region_camera']={'static':fields('THIN_REGION_CAMERA_STATIC '),'pan_oracle':fields('THIN_REGION_PAN '),'pan':fields('THIN_REGION_CAMERA '),'stale':fields('THIN_REGION_STALE '),'box_domain':fields('THIN_REGION_BOX_DOMAIN '),'bad_motion':fields('THIN_REGION_BAD_MOTION '),'timing':fields('LINE_TIMING_CAMERA ')}
    assert [m['kind'] for m in report['thin_region_camera']['bad_motion']]==['overflow_1e30','nan'] and report['thin_region_camera']['bad_motion'][0]['camera_gate_max_within_8px']=='0.0000' and len(report['thin_region_camera']['box_domain'])==1,report['thin_region_camera']
