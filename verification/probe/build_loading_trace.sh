...
"$cxx" $abi -std=c++17 -O2 -Wall -Wextra -Wno-cast-function-type -DWIN32_LEAN_AND_MEAN -DNOMINMAX \
  ...
  loading_trace_fixture.cpp ../../src/proxy/loading_trace.cpp ../../src/proxy/mesh_adjacency_cache.cpp ../../src/ownership/d3d9_ownership.cpp ../../src/ownership/execution_state.cpp ../../src/ownership/finite_buffer_evidence.cpp ../../src/ownership/managed_upload_contract.cpp \
...
"$cxx" $abi -std=c++17 -O2 -Wall -Wextra -Werror -Wno-cast-function-type -DWIN32_LEAN_AND_MEAN -DNOMINMAX \
  -DX3M_LOADING_TRACE_FIXTURE -static -static-libgcc -static-libstdc++ \
  loading_mesh_fixture.cpp ../../src/proxy/loading_trace.cpp ../../src/proxy/mesh_adjacency_cache.cpp ../../src/ownership/d3d9_ownership.cpp ../../src/ownership/execution_state.cpp ../../src/ownership/finite_buffer_evidence.cpp ../../src/ownership/managed_upload_contract.cpp \
