...
"$cxx" -std=c++17 -O2 -Wall -Wextra -Werror -Wno-cast-function-type -DWIN32_LEAN_AND_MEAN -DNOMINMAX \
  -DX3M_LOADING_TRACE_FIXTURE -static -static-libgcc -static-libstdc++ \
  loading_mesh_fixture.cpp ../../src/proxy/loading_trace.cpp \
  build/loading_trace/libd3dx9_fixture.a -luser32 -ldxguid -o build/loading_mesh/loading_mesh_fixture.exe
