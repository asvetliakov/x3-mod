...
def run(no_build=False):
    ...
    bench = [line for line in text.splitlines() if line.startswith(('GAME PHASE BENCH', 'GAME PHASE TARGET BENCH', 'PASS PHASE BENCH', 'LOOP PHASE BENCH', 'RESIDUAL PHASE BENCH', 'MEDIA CUE BENCH'))]
    record = {
