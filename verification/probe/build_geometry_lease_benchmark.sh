...
set -eu
cd "$(dirname "$0")"
admission_objects_dir=build/geometry_lease_benchmark_admission
...
i686-w64-mingw32-g++ -std=c++17 -O2 -Wall -Wextra -Werror -static \
 ...
 geometry_lease_benchmark.cpp ../../src/ownership/d3d9_ownership.cpp "$admission_objects_dir/application_admission.o" "$admission_objects_dir/application_admission_abi.o" -pthread \
