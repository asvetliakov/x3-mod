...
i686-w64-mingw32-g++ -DX3M_OBJECT_LIFETIME_FIXTURE -std=c++17 -O2 -Wall -Wextra -Werror -mno-sse -mno-mmx -mfpmath=387 -mstackrealign -mincoming-stack-boundary=2 \
  -c ../../src/proxy/engine_memory.cpp -o build/engine_memory_object_lifetime.o
i686-w64-mingw32-g++ -DX3M_OBJECT_LIFETIME_FIXTURE -std=c++17 -O2 -Wall -Wextra -Werror -msse2 -mfpmath=sse -mstackrealign -mincoming-stack-boundary=2 -static \
  object_lifetime.cpp ../../src/proxy/object_lifetime.cpp build/engine_memory_object_lifetime.o -o build/object_lifetime.exe -ladvapi32
