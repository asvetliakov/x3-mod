...
struct Graph {
    ...
    WAVEFORMATEX format{}; double duration{}; bool constructed{}; bool audio_enabled{true}; bool pending{};
    ...
    bool decode() {
        ...
        for(int cue=0;cue<2&&ok;++cue) {
            ...
            for(int batch=0;batch<2&&ok;++batch) {
                ...
                hr=t.call("sample_update",1,true,[&]{return sample->Update(SSUPDATE_ASYNC,nullptr,nullptr,0);});
