...
MESH_ADJACENCY_CHECKS=(36093,36150) # exact inventory of the cache-off and cache-on runs (mesh_adjacency_fast_fixture.cpp: 54 named cases, the 2,000-mesh random sweep, the self-test dump replay, state sweep, hook part)
