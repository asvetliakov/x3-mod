...
set -eu
cd "$(dirname "$0")"
admission_objects_dir=build/motion_capture_admission
...
i686-w64-mingw32-g++ -std=c++17 -O2 -Wall -Wextra -Werror -msse2 -mfpmath=sse -mstackrealign -mincoming-stack-boundary=2 -DX3M_DRAW_INPUT_FIXTURE -DX3M_RIGID_MOTION_VERIFICATION -static \
 ...
 ../../src/ownership/d3d9_ownership.cpp "$admission_objects_dir/application_admission.o" "$admission_objects_dir/application_admission_abi.o" -pthread ../../src/ownership/finite_buffer_evidence.cpp ../../src/ownership/portable_managed_upload.cpp ../../src/ownership/execution_state.cpp \
