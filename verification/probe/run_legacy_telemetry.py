...
results=root/'verification/results';probe=root/'verification/probe/build'
wine='/Applications/CrossOver Preview.app/Contents/SharedSupport/CrossOver/bin/wine'
manifest={'dll_sha256':hashlib.sha256((root/'build/d3d9.dll').read_bytes()).hexdigest(),'fixtures':{}}
