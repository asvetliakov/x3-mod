...
i686-w64-mingw32-g++ -std=c++17 -O2 -Wall -Wextra -Werror -msse2 -mfpmath=sse -mstackrealign -mincoming-stack-boundary=2 -static -DX3M_LINEAR_EMISSION_PASS_FIXTURE -DX3M_LINEAR_DISTANCE_FADE_FIXTURE linear_material_fixture.cpp ../../src/renderer/linear_material.cpp ../../src/renderer/linear_emission.cpp ../../src/renderer/material_motion.cpp ../../src/renderer/linear_emission_pass.cpp -o build/distance-fade/linear_material_fixture.exe -luser32 -ldxguid -luuid
