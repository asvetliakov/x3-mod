...
public:
 ...
 bool vs_registered=false,ps_registered=false;std::int8_t ps_sun_register=-1;std::uint8_t vs_major=0,ps_major=0;bool ps_depth_out=false;IDirect3DPixelShader9*ps_emission_variant=nullptr,*emission_eligible_variant=nullptr;
