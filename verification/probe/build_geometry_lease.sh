...
set -eu
cd "$(dirname "$0")"
admission_objects_dir=build/geometry_lease_admission
...
i686-w64-mingw32-g++ -std=c++17 -O2 -Wall -Wextra -Werror -static \
 ...
 geometry_lease_fixture.cpp ../../src/ownership/d3d9_ownership.cpp "$admission_objects_dir/application_admission.o" "$admission_objects_dir/application_admission_abi.o" -pthread \
 ../../src/ownership/execution_state.cpp ../../src/ownership/finite_buffer_evidence.cpp ../../src/ownership/portable_managed_upload.cpp \
 -o build/geometry_lease_fixture.exe -ldxguid -luser32 -ladvapi32
