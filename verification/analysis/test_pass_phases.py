...
class PassPhasesLaunchOption(unittest.TestCase):
    def test_launch_option_removed_and_inherited_value_dropped(self):
        # Since 2026-09-26 the family is a member of --draw-trace (the DLL reads X3M_PASS_PHASES or X3M_DRAW_TRACE=1 through log_tiers.h);
        ...
        with tempfile.TemporaryDirectory() as directory:
            code, _, error = helper.launch(directory, '--perf', '--pass-phases')
