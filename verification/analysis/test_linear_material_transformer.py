"""Compile the real pure transformer and inspect all nine local original programs.
...
class LinearMaterialTransformerTests(unittest.TestCase):
    ...
    def test_all_variants_alias_and_failure_guards(self):
        self.assertEqual((self.driver['programs'], self.driver['pairs'], self.driver['variants']), (9, 10, 72))
        self.assertGreaterEqual(self.driver['checks'], 677)
