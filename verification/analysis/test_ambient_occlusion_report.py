...
RESULT FAIL checks=3 failures=1
'''
...
class AmbientOcclusionReportTests(unittest.TestCase):
    def test_parse(self):
        ...
        self.assertEqual((report['check_count'], report['check_failures']), (3, 1))
        self.assertEqual(report['checks'], {'twin_ps_2_0': True, 'attach_enabled': True, 'oracle_sphere_contact_ring': False})
        ...
        self.assertEqual(report['result'], {'checks': 3, 'failures': 1, 'verdict': 'FAIL'})
