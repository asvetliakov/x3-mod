...
ATTACH enabled=1 largest_program_slots=397 references=6
CHECK attach_enabled PASS
REFERENCE scene=plane width=1280 height=768 pixels=245760 sentinel=0 ones=245760 mean_abs=0.000000 p999=0.000000 max=0.000000 within_002=245760
...
TIMING_QUADS width=1280 height=768 linearize_ms=0.0500 gtao_ms=0.3000 blur_ms=0.1000 apply_ms=0.1500 sum_ms=0.6000 samples=6
RESET PASS references=13 allocations=2
TIMING width=1280 height=768 fenced_on_ms=0.9109 fenced_off_ms=0.0146 submit_ms=0.1366 chain_ms=0.4963 chain_min_ms=0.4500 gpu_ms=0.3597 samples=15
TIMING_VARIANT width=1280 height=768 variant=no_blur fenced_on_ms=0.8091 chain_ms=0.7945 samples=4
TIMING width=1920 height=1080 fenced_on_ms=1.4138 fenced_off_ms=0.0143 submit_ms=0.1106 chain_ms=1.3995 chain_min_ms=1.3500 gpu_ms=1.2889 samples=15
...
class AmbientOcclusionReportTests(unittest.TestCase):
    def test_parse(self):
        ...
        self.assertEqual(report['attach']['largest_program_slots'], 397)
        ...
        self.assertEqual([t['chain_min_ms'] for t in report['timing']], [0.45, 1.35])
