...
def main():
    ...
    parser.add_argument('--linear-materials', action='store_true', help='Evaluate the twenty reviewed Argon and shared hull material pairs in linear space, preserving motion and compatibility-encoding into FP16 (requires --motion-output --hdr --hdr-tonemap and gamma2.2 decode; default off)')
