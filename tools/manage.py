...
def main():
    ...
    if args.action == 'install':
        ...
        # Explicit off value so a stale shell value cannot enable the light-map gain.
        env['X3M_HULL_LIGHTMAP_GAIN'] = repr(args.hull_lightmap_gain if args.hull_lightmap_gain is not None else 1.0)
