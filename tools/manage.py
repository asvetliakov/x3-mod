...
def main():
    ...
    if (args.shadow_caster_retention_age is not None or args.shadow_caster_retention_eps is not None) and not (args.shadow_retention_census or args.shadow_caster_retention):
        parser.error('--shadow-caster-retention-age and --shadow-caster-retention-eps require --shadow-retention-census or --shadow-caster-retention.')
