...
**Implemented 2026-09-18: `--collide-box-cull`** (flown as Run 43 A, run133/run134: patched cleanly, ~17 % of P1 pairs culled, no measurable collide-phase gain, no defect; launcher default on since 2026-09-23 by user decision). Run 42 A named the owner: sector collide
