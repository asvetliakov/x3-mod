...
**Removed 2026-09-25** (user decision): the pass (`--fog-shadow-pass`, `X3M_FOG_SHADOW_PASS`), its visibility, march, repair and mote programs, the grid target and the Ctrl+Shift+F11 toggle are gone; this note is history (`docs/verification/launcher-options-inventory.md`, "4. Removed").
