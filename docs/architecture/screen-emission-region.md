...
Step D (the per-draw vertex hull that replaced the AABB checkpoints for the bullet bound on
2026-09-14) is designed and recorded in [screen-emission-bullet-bound.md](screen-emission-bullet-bound.md).
## Decision
