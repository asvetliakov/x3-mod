...
| Loading telemetry | Patch 16 named imports in the main EXE’s IAT | File, cursor, zlib, XML and D3DX helpers. Original dispatch, patch ownership and restoration are retained. |
