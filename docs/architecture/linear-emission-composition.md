...
default-off live route is now installed for twenty exact SM2 source pairs;
[expanded combined qualification](../verification/combined-glow-materials.md) passes. Gameplay
