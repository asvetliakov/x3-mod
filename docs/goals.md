...
| 17 | Modern third-person chase camera | **In progress.** Run 18 confirms aiming works, the 13° angle is good, and no trembling/visible camera problem was noticed. Requested distance 0.9 and slower 0.28/0.38 s response are reviewed and host-verified; installed defaults remain 0.85 and 0.22/0.30 s. Predictive aim indicator visibility and chase-view persistence across sector travel need fixes; docking is untested. Gameplay frame cost remains unqualified. Vanilla stays the default. |
