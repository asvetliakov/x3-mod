...
| 6 | New material shaders | First Argon slice implements ten archive pairs, including uncaptured variants. Offline proof, 167 GPU cases and 1,220 actual live-route checks pass; independent review and installation are complete; gameplay acceptance remains. Whole-scene linear lighting still needs a policy for every color writer. |
