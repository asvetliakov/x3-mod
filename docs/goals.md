...
| 3 | FP16 lighting and HDR emissive | Held | The opt-in linear material path is installed, but the user plays original hull shading without `--linear-materials` since 2026-09-15 and no further linear-hull processing is planned; scene-wide linear blending and HDR emissive composition are not implemented. | [scene-linear-materials.md](architecture/scene-linear-materials.md) |
...
| 9 | Reflections/SSR | Accepted | Not started; needs a defined off-screen/environment fallback. | [roadmap.md](architecture/roadmap.md) |
| 10 | Improved/soft particles | Accepted | Not started. | [roadmap.md](architecture/roadmap.md) |
...
| 12 | Volumetric nebula/fog | Accepted | Not started. | [roadmap.md](architecture/roadmap.md) |
| 13 | Depth-aware lens effects | Accepted | Not started. | [roadmap.md](architecture/roadmap.md) |
...
| 15 | macOS menu bar | Accepted | Not started; the separate double cursor after alt-tab reproduces in vanilla (run 4, 2026-09-14) and is not a proxy regression. | [window-and-cursor.md](architecture/window-and-cursor.md) |
| 16 | Clustered forward lighting | Accepted | Not started; material and light reconstruction precede implementation. | [roadmap.md](architecture/roadmap.md) |
