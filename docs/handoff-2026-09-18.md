...
- **Installed:** run39 candidate `cc966fb2…` from main `7492137`
  ([build](../verification/results/run39-candidate-build.json),
  [install](../verification/results/run39-candidate-install.json)); rollback
  run38 `5b4be52e…` in `/tmp/x3-candidate-pnXpbE/rollback`.
