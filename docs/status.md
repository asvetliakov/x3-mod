...
Game data: the fleet overlay is being rebaked into `addon/05` + `06` with the new resolver and alpha rule
(install-fleet3; record pending), replacing install-fleet2 (611 bodies); do not launch until that record exists.
