...
is recorded in the [fog ledger](verification/volumetric-fog.md#run49b-run185-visual-rejection-and-reader-validation-2026-09-20); the offline family-density recipe passes its fixed view and temporal checks, and the [first D3D9 march checkpoint](verification/volumetric-fog.md#spatial-fog-first-gpu-march-checkpoint-2026-09-20) passes. The [composite checkpoint](verification/volumetric-fog.md#spatial-fog-composite-checkpoint-2026-09-20) passes nine cases and preserves all 1,649,517 tested empty-input pixels. State/recovery testing now preserves hostile draw state; an injected-failure fixture issue and 32-frame input review findings are being corrected before sequence and full transaction timing. No repeat fog flight is
