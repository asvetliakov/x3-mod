...
**The corrected branch passes 572 checks on each of Steam and X3/FEX. No game
loading speedup from this branch has been measured.** The opt-in switch `--crypt-cache` targets the provider/container
