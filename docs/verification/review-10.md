...
keeps direct descriptor forwarding. See [portable upload](portable-managed-upload.md).
...
See [cache integration](mesh-cache-hook.md).
...
native-Windows measurements. See [upload performance](managed-upload-performance.md).
