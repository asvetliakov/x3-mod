...
| 28 | Next candidate: restore re-arm fix, emitter gain split (engines vs weapon effects), original-program fill A/B, point-light telemetry (opt-in) | 0 | Open: candidate `2b0969e5…` installed 2026-09-16; commands below |
