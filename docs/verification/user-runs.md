...
| 71 A | Merged-LOD atlas overlay from the LOD 0 meshes at the stand (Run70 DLL) | 1 | Queued 2026-09-23; overlay installed (05.cat d29b0c88 / 05.dat 5fd877c1). |
...
Run 71 is the only queued run. Run 70 returned run262/run263 (A), run264 + B2 (B), run265/run268 (C, C2).
