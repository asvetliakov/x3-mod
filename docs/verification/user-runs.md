...
| 40 | 30 km five-cascade set (A), 2048² maps (A2), corvette with the adaptive ladder + retained casters (B), hull emitters at gain 4 (C) | 4 | A run116 flown on the previous build (band gone, 30 km reach; distant flicker diagnosed and fixed); queued again: run40 candidate `c47f039c…` from `e8ae3357` installed 2026-09-18 |
