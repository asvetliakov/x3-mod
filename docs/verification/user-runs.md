...
| 73 A | Merged-LOD batch overlay of the flown sectors (19 bodies) in a busy sector, Run72 DLL | 1 | Queued 2026-09-23; overlay installed in addon/05 ([record](../verification/results/lod-overlay-pilot/install.json)). |
...
Run 73 A is the only queued run. Run 72 returned run270 (A) and run271 (B).
