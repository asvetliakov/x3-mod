# Historical status narrative

Archived 2026-09-14 when `docs/status.md` was condensed to the short current
handoff. This is historical; [docs/status.md](../status.md) is the current
handoff and the earlier snapshot is
[status history 2026-09-13](status-history-2026-09-13.md). The narrative
paragraphs below are the removed text of the 2026-09-14 status, verbatim and in
their original order.

## Removed from status.md on 2026-09-14
...
The installed gameplay build is checkpoint `5d06316` (previous `066e18f` retained for
...
are in the [completed-run archive](user-runs-completed.md), the
