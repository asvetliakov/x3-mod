...
[motion-output](../verification/motion-output.md#gameplay-diagnostic-run) with the route, the
...
the synthetic bench in [motion-output](../verification/motion-output.md#temporal-resolve-step-3):
