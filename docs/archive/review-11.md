...
The [ownership fixture](../verification/ownership-admission.md) passes 147 checks across twelve
...
and [capture/loading hooks](../verification/proxy-application-admission.md) document their own
...
The final [actual-DLL benchmark](../verification/hook-admission-performance.md) passes seven
