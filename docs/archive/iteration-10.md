...
[iteration-09.md](iteration-09.md), [iteration-09-run2.md](../verification/iteration-09-run2.md)
...
table [iteration-09-run2.md §4](../verification/iteration-09-run2.md) tabulated by hand; the
...
1. **The route is not cheaper on FEX in the way the rest of the frame is.** Its
   ...
   identified in [route-cost-run1.md](../verification/route-cost-run1.md), and FEX evidently does
   not help it.
...
Same method as [iteration-09-run2.md §4](../verification/iteration-09-run2.md): mean squared
...
condition [iteration-09-run2.md](../verification/iteration-09-run2.md) already flags as making a
...
Against [iteration-08.md §5](../verification/iteration-08.md), where the same tool measured
